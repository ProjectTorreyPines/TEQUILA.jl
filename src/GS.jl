...
function define_Astar!(Astar, shot, Fis, dFis, Fos, Ps)
    ...
    for m in 0:shot.M
        with_buffers(Fis, dFis, Fos, Ps) do Fi, dFi, Fo, P
...
function define_B!(B, shot, Fis::Channel{<:AbstractVector{<:Complex}}, Fos::Channel{<:AbstractVector{<:Complex}}, Ps::Channel{<:FFTW.FFTWPlan})
    N = shot.N
    M = shot.M
